  ...
  return (
    <div className="container-wrap" id="about">
      ...
      <div className="relative flex flex-col mmd:flex-row gap-10 lg:gap-20 items-center">
        <Image
          src="/images/about-gradient.webp"
          className="absolute left-1/2 transform -translate-x-[48%] -translate-y-[10%] sm:-translate-y-[21%] w-full sm:w-[95%] h-[60%] sm:h-[85%] mmd:w-[70%] mmd:h-full mmd:left-[25%] mmd:top-[25%]"
          alt="about gradient"
          width={100}
          height={500}
          priority
        ...
        <div className="w-full max-w-[420px] lg:max-w-[450px] xl:max-w-[542px] flex flex-col gap-4 lg:gap-6 text-white text-lg lg:text-xl xl:text-2xl font-poppins relative z-10 -top-4 sm:top-0">
          ...
          <p>
            Whether you&apos;re an artist, collector, or investor, Defi Alliance is your gateway to
          ...
          <button
            ...
            className="mint-button border w-[160px] border-secondary text-white py-2 px-6 font-semibold text-xl font-poppins rounded-xl flex items-center gap-2.5 cursor-pointer hover:scale-105 hover:transition-all ease-linear duration-200 active:scale-[1.02] mt-2 mmd:mt-0"
          >
            Mint Now
          </button>
        </div>
